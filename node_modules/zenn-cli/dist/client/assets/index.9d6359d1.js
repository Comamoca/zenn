...
`;const ht=()=>{const e=s.useLocation();return m.exports.useEffect((()=>{e.hash||window.scrollTo(0,0)}),[e]),null},_t=()=>(m.exports.useEffect((()=>{!function(e,t){if(!t)return e();if(void 0===x){const e=document.createElement("link").relList;x=e&&e.supports&&e.supports("modulepreload")?"modulepreload":"preload"}Promise.all(t.map((e=>{if(e in k)return;k[e]=!0;const t=e.endsWith(".css"),r=t?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${r}`))return;const a=document.createElement("link");return a.rel=t?"stylesheet":x,t||(a.as="script",a.crossOrigin=""),a.href=e,document.head.appendChild(a),t?new Promise(((e,t)=>{a.addEventListener("load",e),a.addEventListener("error",t)})):void 0}))).then((()=>e()))}((()=>import("./index.4ffda0fe.js")),void 0)}),[]),o.createElement($,null,o.createElement(j,null,o.createElement(s.RoconRoot,null,o.createElement(ht,null),o.createElement(ut,null,o.createElement(Qe,null))))));y.render(o.createElement(_t,null),document.getElementById("root"));
